$(document).ready(function(){
    ...
    if($(window).width() > 695) {
        ...
        $(document).scroll(function() {
            ...
            if (scrollTop > headerHeight) {
                ...
                logo.css({
                    'background': 'url({{ site.baseurl }}/assets/icons/logo_' + themeStyle + '.svg) no-repeat center',
                ...
                logo.css({
                    'background': 'url({{ site.baseurl }}/assets/icons/logo.svg) no-repeat center',
                    'background-size': '100% 100%'
                });
    ...
    */
    ...
    Search.prototype.autoComplete = function() {
        ...
        $.getJSON('{{ site.baseurl }}/search.json').done(function(data) {
            var html = '';
            for (var i in data) {
                var item = data[i];
